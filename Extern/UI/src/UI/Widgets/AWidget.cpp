...
UI::Widgets::AWidget::AWidget()
{
	m_widgetID = "##" + std::to_string(__WIDGET_ID_INCREMENT++);
}

void UI::Widgets::AWidget::LinkTo(const AWidget& p_widget)
{
...
void UI::Widgets::AWidget::SetParent(Internal::WidgetContainer * p_parent)
{
	m_parent = p_parent;
}

bool UI::Widgets::AWidget::HasParent() const
{
	return m_parent;
}

UI::Internal::WidgetContainer * UI::Widgets::AWidget::GetParent()
{
	return m_parent;
}
