...
struct Example
{
	...
	{
		m_Nodes.emplace_back(GetNextId(), "InputAction Fire", ImColor(255, 255, 128));
	...
	Node* SpawnDoNNode()
	{
		...
		//m_Nodes.back().Outputs.emplace_back(GetNextId(), "Test", PinType::Function);
...
# endif
			...
			{
				if (ImGui::InvisibleButton("restore", ImVec2((float)50, (float)30)))
				{
