...
static  Q_type _QuatD(double w, double h)
{
  using namespace std;
  return (Q_type)(std::abs(w) < std::abs(h) ? std::abs(w) : std::abs(h)) - 4;
}
template <typename Q_type>
static  Q_type _QuatIX(double x, double w, double h)
{
  return (2.0f*(Q_type)x - (Q_type)w - 1.0f)/_QuatD<Q_type>(w, h);
}
template <typename Q_type>
static  Q_type _QuatIY(double y, double w, double h)
{
  ...
  Q_type * quat)
{
  ...
  if( fabs(nqorig)>DOUBLE_EPS_SQ )
  {
      ...
      quat_mult<double>(qrot,qorig,qres);
      quat[0] = qres[0];
      quat[1] = qres[1];
      quat[2] = qres[2];
      quat[3] = qres[3];
...
template void trackball<double>(double, double, double, double const*, double, double, double, double, double*);
// generated by autoexplicit.sh
template void trackball<float>(double, double, float, float const*, double, double, double, double, float*);
template void trackball<float, float>(double, double, double, Eigen::Quaternion<float, 0> const&, double, double, double, double, Eigen::Quaternion<float, 0>&);
template void trackball<double, double>(double, double, double, Eigen::Quaternion<double, 0> const&, double, double, double, double, Eigen::Quaternion<double, 0>&);
