  ...
  id(-1)
{
 ...
 void opengl::ViewerData::set_face_based(bool newvalue)
{
...
// Helpers that draws the most common meshes
 void opengl::ViewerData::set_mesh(
    const Eigen::MatrixXd& _V, const Eigen::MatrixXi& _F)
{
 ...
 void opengl::ViewerData::set_vertices(const Eigen::MatrixXd& _V)
{
  V = _V;
 ...
 void opengl::ViewerData::set_normals(const Eigen::MatrixXd& N)
{
  using namespace std;
  if (N.rows() == V.rows())
  {
 ...
 void opengl::ViewerData::set_visible(bool value, unsigned int core_id /*= 1*/)
{
  if (value)
    is_visible |= core_id;
  else
 ...
 void opengl::ViewerData::copy_options(const ViewerCore &from, const ViewerCore &to)
{
 ...
 void opengl::ViewerData::set_colors(const Eigen::MatrixXd &C)
{
  using namespace std;
 ...
 void opengl::ViewerData::set_uv(const Eigen::MatrixXd& UV)
{
  using namespace std;
  if (UV.rows() == V.rows())
  {
 ...
 void opengl::ViewerData::set_uv(const Eigen::MatrixXd& UV_V, const Eigen::MatrixXi& UV_F)
{
 ...
 void opengl::ViewerData::set_texture(
  ...
  const Eigen::Matrix<unsigned char,Eigen::Dynamic,Eigen::Dynamic>& A)
{
 ...
 void opengl::ViewerData::set_data(
  ...
  int num_steps)
{
 ...
 void opengl::ViewerData::set_data(const Eigen::VectorXd & D, ColorMapType cmap, int num_steps)
{
 ...
 void opengl::ViewerData::set_colormap(const Eigen::MatrixXd & CM)
{
 ...
 void opengl::ViewerData::set_points(
  ...
  const Eigen::MatrixXd& C)
{
 ...
 void opengl::ViewerData::add_points(const Eigen::MatrixXd& P,  const Eigen::MatrixXd& C)
{
 ...
 void opengl::ViewerData::clear_points()
{
  points.resize(0, 6);
}

 void opengl::ViewerData::set_edges(
  const Eigen::MatrixXd& P,
  ...
  const Eigen::MatrixXd& C)
{
 ...
 void opengl::ViewerData::set_edges_from_vector_field(
  const Eigen::MatrixXd& P, 
  ...
  const Eigen::MatrixXd& C)
{
 ...
 void opengl::ViewerData::add_edges(const Eigen::MatrixXd& P1, const Eigen::MatrixXd& P2, const Eigen::MatrixXd& C)
{
 ...
 void opengl::ViewerData::clear_edges()
{
  lines.resize(0, 9);
}

 void opengl::ViewerData::add_label(const Eigen::VectorXd& P,  const std::string& str)
{
 ...
 void opengl::ViewerData::set_labels(const Eigen::MatrixXd& P, const std::vector<std::string>& str)
{
 ...
 void opengl::ViewerData::clear_labels()
{
  labels_positions.resize(0,3);
  labels_strings.clear();
}

 void opengl::ViewerData::clear()
{
 ...
 void opengl::ViewerData::compute_normals()
{
  if(V.cols() == 2)
  {
 ...
 void opengl::ViewerData::uniform_colors(
  ...
  const Eigen::Vector4d& specular)
{
 ...
 void opengl::ViewerData::normal_matcap()
{
  const int size = 512;
 ...
 void opengl::ViewerData::grid_texture()
{
  unsigned size = 128;
...
// Populate VBOs of a particular label stype (Vert, Face, Custom)
 void opengl::ViewerData::update_labels(
 ...
 void opengl::ViewerData::updateGL(
