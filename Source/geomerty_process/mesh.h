...
public:
    ...
    size_t add_vertex(size_t prim_idx, uint32_t idx_in_prim);
    ...
    size_t add_prims(size_t size, uint32_t vertex_count_per_prim = 0, PrimType prim_type = PrimType::Polygon);
    ...
    // topology
    uint32_t prim_num_vertices(size_t prim_idx) const;
    void wire_vertex_prim(size_t vertex_idx, size_t pre_vertex_idx);
    void wire_vertex_prim(size_t vertex_idx, size_t prim_idx, uint32_t idx_in_prim);
